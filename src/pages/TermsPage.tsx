    ...
    <div className="py-16 sm:py-24">
      <Container className="max-w-3xl">
        <SectionHeading
          ...
          description="Serving in a team at Medical Students Fellowship is a commitment. By applying, you agree to the following terms, which help every team serve well and stay unified."
        />
